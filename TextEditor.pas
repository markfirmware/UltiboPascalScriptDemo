...
uses
 GlobalConfig, GlobalConst, Platform, Threads, SysUtils,
 
 {The main FreeVision units for App, Views, Drivers etc}
 Objects, Drivers, Views, Editors, Menus, Dialogs, App,
 {Extra FreeVision units for dialogs and gadgets}
 FVConsts, AsciiTab, Gadgets, TimedDlg, MsgBox, StdDlg;
...
procedure TTVDemo.Idle;
 function IsTileable(P: PView): Boolean; begin
...
begin
 ...
 ConsoleWindowClear(CONSOLE_VIDEO_WINDOW)
end;

begin
  CONSOLE_VIDEO_WINDOW:=ConsoleWindowCreate(ConsoleDeviceGetDefault,CONSOLE_POSITION_BOTTOMRIGHT,True);
end.
